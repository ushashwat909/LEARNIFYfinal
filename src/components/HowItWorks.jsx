...
const steps = [
  ...
  },
  {
    ...
    desc: "As nodes turn green on your knowledge graph, your mastery probability climbs. EduGrav keeps refining until you're truly ready to deploy.",
  },
];

const HowItWorks = () => (
  <section id="how-it-works" style={{ background: '#0B1120', padding: '100px 24px' }}>
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '80px' }}>
        ...
        <h2 style={{ color: '#FFF', fontSize: '2.8rem', marginBottom: '20px' }}>How EduGrav Works</h2>
        <p style={{ color: '#94a3b8', maxWidth: '600px', margin: '0 auto', fontSize: '1.1rem' }}>Four stages from zero to production-ready. Powered by a Directed Acyclic Graph that learns from you.</p>
      </div>
          ...
          >
            <div className="glass" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '15px' }}>
                ...
                <div>
                  <div style={{ fontSize: '0.75rem', color: '#00F0FF', fontWeight: 700, letterSpacing: '2px' }}>STEP {step.num}</div>
                  <h3 style={{ color: '#FFF', fontSize: '1.3rem', margin: 0 }}>{step.title}</h3>
                </div>
              </div>
              <p style={{ color: '#94a3b8', fontSize: '1rem', lineHeight: 1.7, margin: 0 }}>{step.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
