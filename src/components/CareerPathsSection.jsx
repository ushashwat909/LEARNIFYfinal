...
const CareerPathsSection = () => (
  <section style={{ background: '#070d1a', padding: '100px 24px' }}>
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ textAlign: 'center', marginBottom: '70px' }}>
        ...
        <h2 style={{ color: '#FFF', fontSize: '2.8rem', marginBottom: '20px' }}>Career-Indexed Learning Paths</h2>
        <p style={{ color: '#94a3b8', maxWidth: '600px', margin: '0 auto', fontSize: '1.1rem' }}>Every trajectory is a Directed Acyclic Graph mapped to real hiring requirements. Built from job listings, not textbooks.</p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '25px' }}>
        {paths.map((path, i) => (
          <motion.div
            ...
            className="glass"
            style={{ padding: '30px', borderRadius: '20px', cursor: 'default', position: 'relative', overflow: 'hidden' }}
          >
            {/* Glow orb */}
            ...
            <h3 style={{ color: '#FFF', fontSize: '1.2rem', marginBottom: '5px' }}>{path.title}</h3>
